...
@Mixin(value = ItemHazmatSuit.class, remap = false)
public abstract class MixinItemHazmatSuit extends ItemArmor {


    public MixinItemHazmatSuit(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
